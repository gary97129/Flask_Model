...
!function (i, g) {
    ...
    d.formatArr = function (e) {
        ...
        var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position,
            ...
            }), m = r.elemMain = [], u = r.elemHeader = [], c = r.elemCont = [], h = r.table = [],
            ...
            f = (o.zIndex && (y.style.zIndex = o.zIndex), lay.each(new Array(2), function (e) {
                ...
                }), i.insertBefore(l, i.children[0]), n.appendChild(i), m[e] = lay.elem("div", {"class": L + " laydate-main-list-" + e}), m[e].appendChild(a), m[e].appendChild(n), u.push(t), c.push(n), h.push(i)
                ...
                y.appendChild(t)
            }), o.showBottom && y.appendChild(e), lay.elem("style")), p = [], t = (lay.each(o.theme, function (e, t) {
                /^#/.test(t) && (l = !0, p.push(["#{{id}} .layui-laydate-header{background-color:{{theme}};}", "#{{id}} li.layui-this,#{{id}} td.layui-this>div{background-color:{{theme}} !important;}", -1 !== o.theme.indexOf("circle") ? "" : "#{{id}} .layui-this{background-color:{{theme}} !important;}"].join("").replace(/{{id}}/g, r.elemID).replace(/{{theme}}/g, t)))
            }), o.shortcuts && o.range && p.push("#{{id}}.layui-laydate-range{width: 628px;}".replace(/{{id}}/g, r.elemID)), p.length && (p = p.join(""), "styleSheet" in f ? (f.setAttribute("type", "text/css"), f.styleSheet.cssText = p) : f.innerHTML = p, l && lay(y).addClass("laydate-theme-molv"), y.appendChild(f)), r.remove(I.thisElemDate), v.thisId = o.id, s ? o.elem.append(y) : (g.body.appendChild(y), r.position()), o.shade ? '<div class="' + S + '" style="z-index:' + (y.style.zIndex - 1) + "; background-color: " + (o.shade[1] || "#000") + "; opacity: " + (o.shade[0] || o.shade) + '"></div>' : "");
        ...
        }, "month" === s.type && (s.dateTime.date = 1, d.endDate.date = 1)), u && l && (d.setValue(d.parse()), d.hint("value " + a.invalidDate + a.formatError[1])), d.startDate = d.startDate || l && lay.extend({}, s.dateTime), d.autoCalendarModel.auto && d.autoCalendarModel(), d.endState = !s.range || !d.rangeLinked || !(!d.startDate || !d.endDate), e && e(), d
        ...
        var i, l, r, o = this, n = o.config, t = t ? 1 : 0, d = e || o.thisDateTime(t), s = new Date, y = o.lang(),
            m = "date" !== n.type && "datetime" !== n.type, u = lay(o.table[t]).find("td"),
            c = lay(o.elemHeader[t][2]).find("span");
        return d.year < h[0] && (d.year = h[0], o.hint(y.invalidDate)), d.year > h[1] && (d.year = h[1], o.hint(y.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, d)), s.setFullYear(d.year, d.month, 1), i = (s.getDay() + (7 - n.weekStart)) % 7, l = v.getEndDate(d.month || 12, d.year), r = v.getEndDate(d.month + 1, d.year), lay.each(u, function (e, t) {
        ...
        }), lay(c[0]).attr("lay-ym", d.year + "-" + (d.month + 1)), lay(c[1]).attr("lay-ym", d.year + "-" + (d.month + 1)), "cn" === n.lang ? (lay(c[0]).attr("lay-type", "year").html(d.year + " \u5e74"), lay(c[1]).attr("lay-type", "month").html(d.month + 1 + " \u6708")) : (lay(c[0]).attr("lay-type", "month").html(y.month[d.month]), lay(c[1]).attr("lay-type", "year").html(d.year)), m && (n.range ? !e && "init" === a || (o.listYM = [[(o.startDate || n.dateTime).year, (o.startDate || n.dateTime).month + 1], [o.endDate.year, o.endDate.month + 1]], o.list(n.type, 0).list(n.type, 1), "time" === n.type ? o.setBtnStatus("\u65f6\u95f4", lay.extend({}, o.systemDate(), o.startTime), lay.extend({}, o.systemDate(), o.endTime)) : o.setBtnStatus(!0)) : (o.listYM = [[d.year, d.month + 1]], o.list(n.type, 0))), n.range && "init" === a && (o.rangeLinked ? (s = o.getAsYM(d.year, d.month, t ? "sub" : null), o.calendar(lay.extend({}, d, {
            year: s[0],
            month: s[1]
        ...
        var l, r, e, o, d = this, s = d.config, y = d.rangeLinked ? s.dateTime : [s.dateTime, d.endDate][i],
            m = d.lang(), t = s.range && "date" !== s.type && "datetime" !== s.type, u = lay.elem("ul", {
                "class": w + " " + {
                    year: "laydate-year-list",
                    month: "laydate-month-list",
                    time: "laydate-time-list"
                }[n]
            }), a = d.elemHeader[i], c = lay(a[2]).find("span"), h = d.elemCont[i || 0], f = lay(h).find("." + w)[0],
        ...
        }), lay(c[p ? 0 : 1]).attr("lay-ym", l - 8 + "-" + v[1]).html(e + g + " - " + (l - 1) + g)) : "month" === n ? (lay.each(new Array(12), function (e) {
            var t = lay.elem("li", {"lay-ym": e}), a = {year: v[0], month: e, date: 1};
            e + 1 == v[1] && lay(t).addClass(x), t.innerHTML = m.month[e] + (p ? "\u6708" : ""), u.appendChild(t), d.limit({
                elem: lay(t),
                date: a,
                index: i,
                type: n
            })
        }), lay(c[p ? 0 : 1]).attr("lay-ym", v[0] + "-" + v[1]).html(v[0] + g)) : "time" === n && (r = function () {
        ...
        }), r()), f && h.removeChild(f), h.appendChild(u), "year" === n || "month" === n ? (lay(d.elemMain[i]).addClass("laydate-ym-show"), lay(u).find("li").on("click", function () {
        ...
        }, c = lay(a[2]).find("." + M), o(), e.innerHTML = s.range ? [m.startTime, m.endTime][i] : m.timeTips, lay(d.elemMain[i]).addClass("laydate-time-show"), c[0] && c.remove(), a[2].appendChild(e), lay(u).find("ol").each(function (t) {
            var a = this;
...
layui.define("jquery", function (e) {
    "use strict";
    var s = layui.$, a = layui.hint(), o = {
        fixbar: function (i) {
            var o, e, t, n, a = "layui-fixbar", r = s(document), l = (i = s.extend(!0, {
                    target: "body",
                    bars: [],
                    "default": !0,
                    showHeight: 200,
            ...
            layui.each(i.bars, function (e, t) {
                ...
                return c.scrollTop() >= i.showHeight ? e || (o.show(), e = 1) : e && (o.hide(), e = 0), t
            ...
            var i = this, o = "function" == typeof t, a = new Date(e).getTime(),
            ...
            var n = this, i = [[], []], o = (new Date).getTime() - new Date(e).getTime();
            ...
            var n = this, i = new Date(function () {
                ...
                }() || new Date), o = [n.digit(i.getFullYear(), 4), n.digit(i.getMonth() + 1), n.digit(i.getDate())],
...
layui.define(["jquery", "laytpl", "lay"], function (e) {
    "use strict";
    var n, i, t, s = layui.$, m = layui.laytpl, a = layui.hint(),
        o = layui.device().mobile ? "touchstart" : "mousedown", r = "dropdown", c = "layui_" + r + "_index", p = {
        ...
        }, l = "layui-menu-item-up", u = "layui-menu-item-down", f = "layui-menu-body-title", d = "layui-menu-item-group",
        h = "layui-menu-item-parent", g = "layui-menu-item-checked", v = "layui-menu-item-checked2",
    ...
    b.prototype.config = {
        ...
        }), i) : !e && n[0] && n.data(c) ? (n = y.getThis(n.data(c))) ? n.reload(t) : void 0 : (t.id = "id" in t ? t.id : i.index, t.show && i.render(e), void i.events())
    }, b.prototype.render = function (e) {
        var l = this, u = l.config, i = s("body"), d = function (r, e) {
        ...
        !(e = "contextmenu" !== u.trigger && !lay.isTopElem(u.elem[0]) ? e : !0) && u.elem.data(c + "_opened") || (l.elemView = s(t), l.elemView.append(u.content || (e = s('<ul class="layui-menu layui-dropdown-menu"></ul>'), 0 < u.data.length ? d(e, u.data) : e.html('<li class="layui-menu-item-none">no menu</li>'), e)), u.className && l.elemView.addClass(u.className), u.style && l.elemView.attr("style", u.style), p.thisId = u.id, l.remove(), i.append(l.elemView), u.elem.data(c + "_opened", !0), t = u.shade ? '<div class="' + V + '" style="z-index:' + (l.elemView.css("z-index") - 1) + "; background-color: " + (u.shade[1] || "#000") + "; opacity: " + (u.shade[0] || u.shade) + '"></div>' : "", l.elemView.before(t), l.position(), (y.prevElem = l.elemView).data("prevElem", u.elem), l.elemView.find(".layui-menu").on(o, function (e) {
            layui.stope(e)
        }), l.elemView.find(".layui-menu li").on("click", function (e) {
            var i = s(this), t = i.data("item") || {}, n = t.child && 0 < t.child.length, a = "all" === u.clickScope;
            n && !a || "-" === t.type || (!1 === ("function" == typeof u.click && u.click(t, i)) || n || l.remove(), layui.stope(e))
        ...
        "hover" === t.trigger && (t.trigger = "mouseenter"), i.prevElem && i.prevElem.off(t.trigger, i.prevElemCallback), i.prevElem = t.elem, i.prevElemCallback = function (e) {
            clearTimeout(y.timer), i.e = e, i.render(), e.preventDefault(), "function" == typeof t.ready && t.ready(i.elemView, t.elem, i.e.target)
        ...
        e.hasClass(l) ? (e.removeClass(l).addClass(u), i.removeClass("layui-icon-down").addClass("layui-icon-up")) : (e.removeClass(u).addClass(l), i.removeClass("layui-icon-up").addClass("layui-icon-down"))
        ...
        var i, t;
        !p.thisId || (i = y.getThis(p.thisId)) && (t = i.config, !lay.isTopElem(t.elem[0]) && "contextmenu" !== t.trigger && (e.target === t.elem[0] || t.elem.find(e.target)[0] || e.target === i.elemView[0] || i.elemView && i.elemView.find(e.target)[0]) || i.remove())
    }), t = ".layui-menu:not(.layui-dropdown-menu) li", i.on("click", t, function (e) {
        var i = s(this), t = i.parents(".layui-menu").eq(0), n = i.hasClass(d) || i.hasClass(h),
            a = t.attr("lay-filter") || t.attr("id"), l = lay.options(this);
        i.hasClass("layui-menu-item-divider") || n || (t.find("." + g).removeClass(g), t.find("." + v).removeClass(v), i.addClass(g), i.parents("." + h).addClass(v), layui.event.call(this, r, "click(" + a + ")", l))
    }), i.on("click", t + x, function (e) {
        var i = s(this).parents("." + d + ":eq(0)"), t = lay.options(i[0]);
    ...
    d.prototype.config = {
        ...
        var c = this, a = c.config, s = c.elemColorBox.find("." + C), d = c.elemPicker.find("." + M + " input"), o = {
            clear: function (e) {
                ...
                var o, r, t, n, l = d.val();
                if (-1 < l.indexOf(",") ? (r = T(L(l)), c.select(r.h, r.s, r.b), s[0].style.background = o = "#" + j(r), 3 < (l.match(/[0-9]{1,3}/g) || []).length && "rgba" === s.attr("lay-type") && (t = 280 * l.slice(l.lastIndexOf(",") + 1, l.length - 1), c.elemPicker.find("." + E).css("left", t), o = s[0].style.background = l)) : (3 === (t = -1 < (t = l).indexOf("#") ? t.substring(1) : t).length && (t = (n = t.split(""))[0] + n[0] + n[1] + n[1] + n[2] + n[2]), n = {
                    r: (t = parseInt(t, 16)) >> 16,
                    g: (65280 & t) >> 8,
                    b: 255 & t
                }, r = T(n), s[0].style.background = o = "#" + j(r), c.elemColorBox.find("." + B).removeClass(P).addClass(x)), "change" === i) return c.select(r.h, r.s, r.b, i), void (a.change && a.change(o));
...
layui.define(["lay", "layer", "util"], function (e) {
    "use strict";
    var b = layui.$, h = layui.layer, d = layui.util, l = layui.hint(), w = (layui.device(), "form"), o = ".layui-form",
        T = "layui-this", $ = "layui-hide", F = "layui-disabled", t = function () {
            ...
            var i = this.config, a = b(o + (t ? '[lay-filter="' + t + '"]' : "")), n = {
                input: function (e) {
                    ...
                    i.autocomplete && e.attr("autocomplete", i.autocomplete), a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                        var l = b(this), r = l.attr("lay-affix"), s = "layui-input-suffix", o = "layui-input-affix",
                            e = l.is("[disabled]") || l.is("[readonly]"), c = function (e, t) {
                                (e = b(e))[0] && e[b.trim(t) ? "removeClass" : "addClass"]($)
                            }, n = function (t) {
                                t = b.extend({}, u[r] || {value: r}, t, lay.options(l[0]));
                                var i = b('<div class="' + o + '">'),
                                    e = b('<i class="layui-icon layui-icon-' + t.value + (t.disabled ? " " + F : "") + '"></i>'),
                                ...
                                n[0] ? ((a = n.find("." + o))[0] && a.remove(), n.prepend(i), l.css("padding-right", function () {
                                    ...
                                    b(this).hasClass(F) || ("function" == typeof t.click && t.click.call(this, l, t), layui.event.call(this, w, "input-affix(" + e + ")", {
                                        elem: l[0],
                                        affix: r,
                                        options: t
                                    }))
                    ...
                    var v, c = "\u8bf7\u9009\u62e9", m = "layui-form-select", g = "layui-select-title",
                        x = "layui-select-none", k = "", e = e || a.find("select"), C = function (e, t) {
                            b(e.target).parent().hasClass(g) && !t || (b("." + m).removeClass(m + "ed " + m + "up"), v && k && v.val(k)), v = null
                        }, u = function (a, e, t) {
                            var s, r, i, n, o, l, c = b(this), u = a.find("." + g), d = u.find("input"), f = a.find("dl"),
                                h = f.children("dd"), y = f.children("dt"), p = this.selectedIndex;
                            e || (r = c.attr("lay-search"), i = function () {
                                var e = a.offset().top + a.outerHeight() + 5 - q.scrollTop(), t = f.outerHeight();
                                p = c[0].selectedIndex, a.addClass(m + "ed"), h.removeClass($), y.removeClass($), s = null, h.removeClass(T), 0 <= p && h.eq(p).addClass(T), e + t > q.height() && t <= e && a.addClass(m + "up"), o()
                            }, n = function (e) {
                                ...
                                var l = 0, t = (layui.each(h, function () {
                                    ...
                                    var e = b(this), t = e.nextUntil("dt").filter("dd");
                                ...
                                var t = c[0].selectedIndex;
                                v = d, k = b(c[0].options[t]).html(), 0 === t && k === d.attr("placeholder") && (k = ""), setTimeout(function () {
                                    l(d.val(), function (e) {
                                        k || d.val("")
                                    }, "blur")
                                }, 200)
                            }), h.on("click", function () {
                                var e = b(this), t = e.attr("lay-value"), i = c.attr("lay-filter");
                    ...
                    e.each(function (e, t) {
                        var i = b(this), a = i.next("." + m), n = this.disabled, l = t.value,
                            r = b(t.options[t.selectedIndex]), t = t.options[0];
                        ...
                        var s, o = "string" == typeof i.attr("lay-search"), t = t && !t.value && t.innerHTML || c,
                            r = b(['<div class="' + (o ? "" : "layui-unselect ") + m, (n ? " layui-select-disabled" : "") + '">', '<div class="' + g + '">', '<input type="text" placeholder="' + d.escape(b.trim(t)) + '" value="' + d.escape(b.trim(l ? r.html() : "")) + '"' + (!n && o ? "" : " readonly") + ' class="layui-input' + (o ? "" : " layui-unselect") + (n ? " " + F : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (t = i.find("*"), s = [], layui.each(t, function (e, t) {
                                ...
                                0 !== e || t.value || "optgroup" === i ? "optgroup" === i ? s.push("<dt>" + t.label + "</dt>") : s.push('<dd lay-value="' + d.escape(t.value) + '" class="' + (l === t.value ? T : "") + (t.disabled ? " " + F : "") + '">' + b.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + b.trim(t.innerHTML || c) + "</dd>")
                    ...
                    }, e = e || a.find("input[type=checkbox]"), c = {primary: !0, tag: !0, "switch": !0};
                    e.each(function (e, t) {
                        var i = b(this), a = i.attr("lay-skin") || "primary",
                            n = b.trim(t.title || (t.title = i.attr("lay-text") || "")).split("|"), l = this.disabled,
                            r = o[a = c[a] ? a : "primary"] || o.checkbox;
                        if ("string" == typeof i.attr("lay-ignore")) return i.show();
                        var s = i.next("." + r[0]),
                            t = b(['<div class="layui-unselect ' + r[0], t.checked ? " " + r[1] : "", l ? " layui-checkbox-disabled " + F : "", '"', a ? ' lay-skin="' + a + '"' : "", ">", (l = {
                                checkbox: [n[0] ? "<span>" + d.escape(n[0]) + "</span>" : "", '<i class="layui-icon layui-icon-ok"></i>'].join(""),
                                "switch": "<em>" + ((t.checked ? n[0] : n[1]) || "") + "</em><i></i>"
                            })[a] || l.checkbox, "</div>"].join(""));
                        s[0] && s.remove(), i.after(t), function (i, a) {
                            var n = b(this);
                            i.on("click", function () {
                                var e = n.attr("lay-filter"), t = (n.attr("title") || "").split("|");
                    ...
                    e.each(function (e, t) {
                        var i = b(this), a = i.next("." + r), n = this.disabled;
                        if ("string" == typeof i.attr("lay-ignore")) return i.show();
                        a[0] && a.remove();
                        n = b(['<div class="layui-unselect ' + r, t.checked ? " " + r + "ed" : "", (n ? " layui-radio-disabled " + F : "") + '">', '<i class="layui-anim layui-icon">' + s[t.checked ? 0 : 1] + "</i>", "<div>" + (a = d.escape(t.title || ""), a = "string" == typeof i.next().attr("lay-radio") ? i.next().html() : a) + "</div>", "</div>"].join(""));
                        i.after(n), function (a) {
                            var n = b(this), l = "layui-anim-scaleSpring";
                            a.on("click", function () {
            ...
            return !(e = b(e))[0] || (e.attr("lay-verify") !== undefined || !1 !== this.validate(e.find("*[lay-verify]"))) && (layui.each(e, function (e, r) {
                var s = b(this), t = (s.attr("lay-verify") || "").split("|"), o = s.attr("lay-vertype"), c = s.val();
            ...
            var i = b(this), e = "string" == typeof e ? e : i.attr("lay-filter"),
        ...
        }), r = new t, t = b(document), q = b(window);
    b(function () {
        r.render()
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (e) {
    "use strict";
    var v = layui.$, r = layui.lay, g = layui.laytpl, S = layui.laypage, b = layui.layer, h = layui.form,
        x = layui.util, u = layui.hint(), p = layui.device(), k = {
            config: {
            ...
            var t = f.that[e];
            return t || u.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"), t || null
        }, l = function (e) {
            var t = f.config[e];
            return t || u.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"), t || null
        }, C = function (e) {
        ...
        }, w = "table", t = ".layui-table", T = "layui-hide", d = "layui-hide-v", c = "layui-none", L = "layui-table-view",
        o = ".layui-table-header", N = ".layui-table-body", s = ".layui-table-pageview", D = ".layui-table-sort",
        A = "layui-table-edit", E = "layui-table-hover", W = "laytable-cell-group", R = "layui-table-col-special",
        _ = "layui-table-tool-panel", j = "LAY_TABLE_MOVE_DICT", a = function (e) {
        ...
        M = v(window), H = v(document), n = function (e) {
            ...
            a.index = t.index, t.key = a.id || a.index, t.setInit(), a.height && /^full-\d+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1], a.height = M.height() - t.fullHeightGap) : a.height && /^#\w+\S*-\d+$/.test(a.height) && (e = a.height.split("-"), t.parentHeightGap = e.pop(), t.parentDiv = e.join("-"), a.height = v(t.parentDiv).height() - t.parentHeightGap);
            var i, e = a.elem, l = e.next("." + L), n = t.elem = v("<div></div>");
            n.addClass((i = [L, L + "-" + t.index, "layui-form", "layui-border-box"], a.className && i.push(a.className), i.join(" "))).attr({
            ...
            i[0] && (t = t.split("-"), t = a.cols[t[1]][t[2]], e ? l-- : l++, i.attr("colspan", l), i[1 <= l || !e ? "removeClass" : "addClass"](T), t.colspan = l, t.hide = 1 <= l || !e, (a = i.data("parentkey")) && this.setParentCol(e, a))
            ...
            var e, l = this;
            l.config.cols.length <= 1 || ((e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + W)).css("width", 0), layui.each(e.get().reverse(), function () {
            ...
            var t, a, n = this, d = n.config, i = 0, r = 0, c = 0, s = 0, y = n.setInit("width"),
                e = (n.eachCols(function (e, t) {
                    t.hide || i++
                }), y = y - ("line" === d.skin || "nob" === d.skin ? 2 : i + 1) - n.getScrollWidth(n.layMain[0]) - 1, function (o) {
                    layui.each(d.cols, function (e, n) {
                        layui.each(n, function (e, t) {
                            var a = 0, i = t.minWidth || d.cellMinWidth, l = t.maxWidth || d.cellMaxWidth;
                            t ? t.colGroup || t.hide || (o ? c && c < i ? (r--, a = i) : c && l < c && (r--, a = l) : (a = t.width || 0, /\d+%$/.test(a) ? l < (a = (a = Math.floor(parseFloat(a) / 100 * y)) < i ? i : a) && (a = l) : a ? "normal" === t.type && (a < i && (t.width = a = i), l < a && (t.width = a = l)) : (t.width = a = 0, r++)), t.hide && (a = 0), s += a) : n.splice(e, 1)
                        })
                    }), s < y && 0 < r && (c = (y - s) / r)
            ...
            var t = this, a = t.layMain.find("." + c), e = v('<div class="' + c + '">' + (e || "Error") + "</div>");
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(T), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(d), t.layPage.find(s).addClass(d), k.cache[t.key] = [], t.syncCheckAll()
            ...
            var u = this, h = u.config, t = e.res, a = e.curr, i = e.count, l = e.sort, n = t[h.response.dataName] || [],
                t = t[h.response.totalRowName], p = [], f = [], m = [], o = function () {
                    var y;
                    if (h.HAS_SET_COLS_PATCH || u.setColsPatch(), h.HAS_SET_COLS_PATCH = !0, !l && u.sortKey) return u.sort({
                    ...
                    layui.each(n, function (o, d) {
                        ...
                        "array" === layui.type(d) && 0 === d.length || (d[k.config.numbersName] = s, l || (d[k.config.indexName] = o), u.eachCols(function (e, l) {
                            var t, e = l.field || e, a = l.key, n = d[e];
                            n !== undefined && null !== n || (n = ""), l.colGroup || (t = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(d) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + x.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(T), l.field || t.push(R), t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + (e = [], l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ">" + function () {
                                ...
                                switch (l.type) {
                                    ...
                                    case"radio":
                                        return t[a] && (y = o), '<input type="radio" name="layTableRadio_' + h.index + '" ' + (e = [], t[a] && (e[0] = "checked"), t[i] && e.push("disabled"), e.join(" ")) + ' lay-type="layTableRadio">';
                                    case"numbers":
                                        return s
                                }
                                return l.toolbar ? g(v(l.toolbar).html() || "").render(t) : C.call(u, {
                                    item3: l,
                                    content: n,
                                    tplData: t
                                })
                            }(), "</div></td>"].join(""), i.push(t), l.fixed && "right" !== l.fixed && r.push(t), "right" === l.fixed && c.push(t))
                        }), p.push('<tr data-index="' + o + '">' + i.join("") + "</tr>"), f.push('<tr data-index="' + o + '">' + r.join("") + "</tr>"), m.push('<tr data-index="' + o + '">' + c.join("") + "</tr>"))
                    }), "fixed" === h.scrollPos && "reloadData" === e.type || u.layBody.scrollTop(0), "reset" === h.scrollPos && u.layBody.scrollLeft(0), u.layMain.find("." + c).remove(), u.layMain.find("tbody").html(p.join("")), u.layFixLeft.find("tbody").html(f.join("")), u.layFixRight.find("tbody").html(m.join("")), u.renderForm(), "number" == typeof y && u.setRowChecked({
                        type: "radio",
                        index: y
                    }, !0), u.syncCheckAll(), u.fullSize(), u.haveInit ? u.scrollPatch() : setTimeout(function () {
                        u.scrollPatch()
                    }, 50), u.haveInit = !0, b.close(u.tipsIndex)
                };
            return k.cache[u.key] = n, u.layTotal[0 == n.length ? "addClass" : "removeClass"](d), u.layPage[h.page || h.pagebar ? "removeClass" : "addClass"](T), u.layPage.find(s)[!h.page || 0 == i || 0 === n.length && 1 == a ? "addClass" : "removeClass"](d), 0 === n.length ? (u.renderForm(), u.errorView(h.text.none)) : (u.layFixLeft.removeClass(T), l ? o() : (o(), u.renderTotal(n, t), u.layTotal && u.layTotal.removeClass(T), void (h.page && (h.page = v.extend({
            ...
            c.totalRow && (layui.each(e, function (e, i) {
                ...
                var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2,
                    ...
                    l = (a = t.totalRowText || "", (n = {LAY_COL: t})[e] = l, n = t.totalRow && C.call(r, {
                        item3: t,
                        content: l,
                        tplData: n
            ...
            var t = this, i = t.config, l = "layui-table-click",
                n = t.layBody.find("tr" + ("all" === a.index ? "" : '[data-index="' + a.index + '"]'));
            "checkbox" === (a = v.extend({
                type: "checkbox",
                checked: !0
            }, a)).type || a.isAll || n.addClass(l).siblings("tr").removeClass(l), e || (l = k.cache[t.key], layui.each(l, function (e, t) {
                a.index === e || "all" === a.index ? t[i.checkName] = a.checked : "radio" === a.type && delete t[i.checkName]
            }), n.find('input[lay-type="' + ({
                radio: "layTableRadio",
                checkbox: "layTableCheckbox"
            }[a.type] || "checkbox") + '"]').prop("checked", a.checked), t.syncCheckAll(), t.renderForm(a.type))
            ...
            try {
                ...
                t.layHeader.find("th").find(D).removeAttr("lay-sort"), c.attr("lay-sort", l.type || null), t.layFixed.find("th")
            } catch (s) {
            ...
            t.sortKey = {
                field: d,
                sort: l.type
            }, i.autoSort && ("asc" === l.type ? e = layui.sort(o, d) : "desc" === l.type ? e = layui.sort(o, d, !0) : (e = layui.sort(o, k.config.indexName), delete t.sortKey, delete i.initSort)), a[i.response.dataName] = e || o, t.renderData({
                res: a,
                curr: t.page,
                count: t.count,
                sort: !0,
            ...
            i.fullHeightGap ? (l = M.height() - i.fullHeightGap, i.elem.css("height", l = l < 135 ? 135 : l)) : i.parentDiv && i.parentHeightGap && (l = v(i.parentDiv).height() - i.parentHeightGap, i.elem.css("height", l = l < 135 ? 135 : l)), 1 < t.cols.length && (e = i.layFixed.find(o).find("th"), a = i.layHeader.first(), layui.each(e, function (e, t) {
            ...
            e.layFixed.find(N).css("height", t.height() >= n ? n : "auto"), e.layFixRight[0 < l ? "removeClass" : "addClass"](T), e.layFixRight.css("right", a - 1)
        }, n.prototype.events = function () {
            var s = this, y = s.config, r = y.elem.attr("lay-filter"), e = s.layHeader.find("th"), u = ".layui-table-cell",
                n = v("body"), o = {}, d = (s.layTool.on("click", "*[lay-event]", function (e) {
                    var a, i = v(this), t = i.attr("lay-event"), l = function (e) {
                        var t = v(e.list), a = v('<ul class="' + _ + '"></ul>');
                        a.html(t), y.height && a.css("max-height", y.height - (s.layTool.outerHeight() || 50)), i.find("." + _)[0] || i.append(a), s.renderForm(), a.on("click", function (e) {
                            layui.stope(e)
                        }), e.done && e.done(a, t)
                    };
                    switch (layui.stope(e), H.trigger("table.tool.panel.remove"), b.close(s.tipsIndex), t) {
                        case"LAYTABLE_COLS":
                            l({
                                list: (a = [], s.eachCols(function (e, t) {
                                    ...
                                    h.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                        var e = v(e.elem), t = this.checked, a = e.data("key"), i = s.col(a), l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, s.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](T), l != i.hide && s.setParentCol(!t, e), s.resize(), layui.event.call(this, w, "colToggled(" + r + ")", {
                                            col: i,
                                            config: y
                                        }))
                                    })
                        ...
                        case"LAYTABLE_PRINT":
                            ...
                            d.append(s.layMain.find("table").html()), d.append(s.layTotal.find("table").html()), d.find("th.layui-table-patch").remove(), d.find("thead>tr>th." + R).filter(function (e, t) {
                                return !v(t).children("." + W).length
                            }).remove(), d.find("tbody>tr>td." + R).remove(), n.document.write(o + d.prop("outerHTML")), n.document.close(), n.print(), n.close()
                    }
                    layui.event.call(this, w, "toolbar(" + r + ")", v.extend({event: t, config: y}, {}))
                }), s.layPagebar.on("click", "*[lay-event]", function (e) {
                    var t = v(this).attr("lay-event");
                    layui.event.call(this, w, "pagebar(" + r + ")", v.extend({event: t, config: y}, {}))
                }), e.on("mousemove", function (e) {
                    var t = v(this), a = t.offset().left, e = e.clientX - a;
                    t.data("unresize") || f.eventMoveElem || (o.allowResize = t.width() - e <= 10, n.css("cursor", o.allowResize ? "col-resize" : ""))
                }).on("mouseleave", function () {
                    v(this);
                    ...
                    o.allowResize && (t = a.data("key"), e.preventDefault(), o.offset = [e.clientX, e.clientY], s.getCssRule(t, function (e) {
                        var t = e.style.width || a.outerWidth();
                        o.rule = e, o.ruleWidth = parseFloat(t), o.minWidth = a.data("minwidth") || y.cellMinWidth, o.maxWidth = a.data("maxwidth") || y.cellMaxWidth
                    }), a.data(j, o), f.eventMoveElem = a)
                }), f.docEvent || H.on("mousemove", function (e) {
                    var t, a;
                    f.eventMoveElem && (t = f.eventMoveElem.data(j) || {}, f.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule && (e = t.ruleWidth + e.clientX - t.offset[0], a = f.eventMoveElem.closest("." + L).attr("lay-id"), (a = m(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(f.eventMoveElem), b.close(s.tipsIndex))))
                }).on("mouseup", function (e) {
                    var t, a, i, l;
                    f.eventMoveElem && (i = (t = f.eventMoveElem).closest("." + L).attr("lay-id"), (a = m(i)) && (i = t.data("key"), l = a.col(i), o = {}, n.css("cursor", ""), a.scrollPatch(), t.removeData(j), delete f.eventMoveElem, a.getCssRule(i, function (e) {
                        l.width = parseFloat(e.style.width), layui.event.call(t[0], w, "colResized(" + r + ")", {
                            col: l,
                            config: a.config
                        })
                    })))
                }), f.docEvent = !0, e.on("click", function (e) {
                    var t = v(this), a = t.find(D), i = a.attr("lay-sort");
                    ...
                    var t = v(this).parents("tr").eq(0).data("index"), r = s.layBody.find('tr[data-index="' + t + '"]'),
                        c = (c = k.cache[s.key] || [])[t] || {}, a = {
                            tr: r, config: y, data: k.clearCacheKey(c), index: t, del: function () {
                                ...
                                e = e || {}, layui.each(e, function (i, l) {
                                    ...
                                    c[i] = a.data[i] = l, s.eachCols(function (e, t) {
                                        ...
                                        })), n.data("content", l)) : d && (t.templet || t.toolbar) && (e = r.children('td[data-field="' + (t.field || e) + '"]'), a = c[t.field], e.children(u).html(C.call(s, {
                                            item3: t,
                                            content: a,
                                            tplData: v.extend({LAY_COL: t}, c)
                                        })), e.data("content", a))
                                ...
                                s.setRowChecked(v.extend({type: "radio", index: t}, e))
                            }
                        };
                    return v.extend(a, e)
                    ...
                    }), s.syncCheckAll(), s.renderForm("checkbox")) : (s.setCheckData(a, i), s.syncCheckAll()), layui.event.call(e[0], w, "checkbox(" + r + ")", d.call(e[0], {
                        checked: i,
                        type: l ? "all" : "one"
                    })))
                }), s.elem.on("click", 'input[lay-type="layTableRadio"]+', function () {
                    var e = v(this).prev(), t = e[0].checked, e = e.parents("tr").eq(0).data("index");
                    s.setRowChecked({
                        type: "radio",
                        index: e
                    ...
                    var t = v(this);
                    t.data("off") || layui.event.call(this, w, e + "(" + r + ")", d.call(t.children("td")[0]))
                }), c = function (e, t) {
                    var a, i, l, n;
                    ...
                    var t = v(this), a = t.children(u);
                    t.data("off") || (e ? t.find(".layui-table-grid-down").remove() : !(a.prop("scrollWidth") > a.outerWidth() || 0 < a.find("br").length) || y.lineStyle || a.find("." + i)[0] || t.append('<div class="' + i + '"><i class="layui-icon layui-icon-down"></i></div>'))
                }, l = (s.layBody.on("click", "." + i, function (e) {
                    var t = v(this).parent().children(u);
                    s.tipsIndex = b.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (t.height() + 23) + "px;" + ("sm" === y.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === y.size ? "padding: 14px 15px;" : "") + '">', t.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), t[0], {
                        tips: [3, ""],
                        time: -1,
                        anim: -1,
                    ...
                    layui.event.call(this, w, (e || "tool") + "(" + r + ")", d.call(this, {event: t.attr("lay-event")})), s.setRowChecked({
                        type: "radio",
                        index: a
                    }, !0)
                });
            s.layBody.on("click", "*[lay-event]", function (e) {
                ...
                s.layHeader.scrollLeft(t), s.layTotal.scrollLeft(t), s.layFixed.find(N).scrollTop(e), b.close(s.tipsIndex)
            ...
            o = o || {};
            var e = "object" == typeof i ? i : v("string" == typeof i ? 'table[lay-filter="' + i + '"]' : t + "[lay-data], " + t + "[lay-options]"),
            ...
            l.colGroup && (n = 0, a++, l.CHILD_COLS = [], o = e + (parseInt(l.rowspan) || 1), layui.each(i[o], function (e, t) {
                t.parentKey ? t.parentKey === l.key && (t.PARENT_COL_INDEX = a, l.CHILD_COLS.push(t), y(a, i, o, t)) : t.PARENT_COL_INDEX || 1 <= n && n == (l.colspan || 1) || (t.PARENT_COL_INDEX = a, l.CHILD_COLS.push(t), n += t.hide ? 0 : parseInt(1 < t.colspan ? t.colspan : 1), y(a, i, o, t))
            }))
        });
    k.eachCols = function (e, a, i) {
        var e = f.config[e] || {}, l = [], n = (i = v.extend(!0, [], i || e.cols), layui.each(i, function (a, e) {
            if (a) return !0;
            layui.each(e, function (e, t) {
        ...
        var o, d, i, r, l = (a = "object" == typeof a ? a : (l = {}, a && (l.type = a), l)).type || "csv",
            c = f.that[e], n = f.config[e] || {}, s = {csv: "text/csv", xls: "application/vnd.ms-excel"}[l],
            y = document.createElement("a");
        if (p.ie) return u.error("IE_NOT_SUPPORT_EXPORTS");
        y.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [], d = [], i = [], r = {}, layui.each(t, function (i, l) {
            var n = [];
            "object" == typeof e ? (layui.each(e, function (e, t) {
                0 == i && o.push(t || "")
            }), layui.each(layui.isArray(l) ? v.extend([], l) : k.clearCacheKey(l), function (e, t) {
                n.push('"' + (t || "") + '"')
            })) : k.eachCols(e, function (e, t) {
                var a;
                t.field && "normal" == t.type && (t.hide ? 0 == i && (r[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""), 0 == i && o.push(t.fieldTitle || t.title || t.field || ""), a = (a = C.call(c, {
                    item3: t,
                    content: a,
                    tplData: l,
                    text: "text",
        ...
        }), o.join(",") + "\r\n" + d.join("\r\n") + "\r\n" + i.join(","))), y.download = (a.title || n.title || "table_" + (n.index || "")) + "." + l, document.body.appendChild(y), y.click(), document.body.removeChild(y)
        ...
        n && ("boolean" === layui.type(l) ? n.eachCols(function (e, t) {
            ...
            i.hide != l && (i = i.hide = l, n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](T), n.setParentCol(i, t))
        }) : layui.each(l, function (e, l) {
            n.eachCols(function (e, t) {
                var a, i;
                l.field === t.field && (a = t.key, i = n.col(a), t = t.parentKey, "hide" in l && i.hide != l.hide && (i = i.hide = !!l.hide, n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](T), n.setParentCol(i, t)))
            })
        }), v("." + _).remove(), n.resize())
...
layui.define(["lay", "util", "element", "form"], function (e) {
    "use strict";
    var M = layui.$, _ = layui.util, w = layui.element, C = layui.form, b = {
    ...
    e("code", function (e) {
        ...
        e.elem = M(e.elem), e.elem[0] && layui.each(e.elem.get().reverse(), function (e, l) {
            var t, i, a, s, n, o, d, r, c, u, E = M(l), y = I(E.html()),
                v = M.extend(!0, {}, L, lay.options(l), (t = {}, layui.each(["title", "height", "encode", "skin", "about"], function (e, l) {
                    var i = E.attr("lay-" + l);
                    "string" == typeof i && (t[l] = i)
                }), t)), f = (i = [], (l = E.children("textarea")).each(function () {
                    i.push(I(this.value))
                }), l[0] && (y = _.escape(i.join(""))), 0 === i.length && i.push(I(E.html())), i),
                h = (v.preview && (l = "LAY-CODE-DF-" + e, a = v.layout || ["code", "preview"], s = "iframe" === v.preview, p = M('<div class="' + b.ELEM_PREVIEW + '">'), u = M('<div class="layui-tab layui-tab-brief">'), n = M('<div class="layui-tab-title">'), o = M('<div class="' + [b.ELEM_ITEM, b.ELEM_ITEM + "-preview", "layui-border"].join(" ") + '">'), d = M('<div class="layui-code-tools"></div>'), h = E.prev("." + b.ELEM_PREVIEW), m = E.next("." + b.ELEM_ITEM + "-preview"), v.id && p.attr("id", v.id), u.attr("lay-filter", l), layui.each(a, function (e, l) {
                    var i = M('<li lay-id="' + l + '">');
                    ...
                    full: {
                        ...
                        title: ["\u6700\u5927\u5316\u663e\u793a", "\u8fd8\u539f\u663e\u793a"],
                        event: function (e, l) {
                            var i = e.closest("." + b.ELEM_PREVIEW), t = "layui-icon-" + this.className,
                                a = "layui-icon-screen-restore", s = this.title, n = M("html,body"),
                                o = "layui-scollbar-hide";
                            e.hasClass(t) ? (i.addClass(b.ELEM_FULL), e.removeClass(t).addClass(a), e.attr("title", s[1]), n.addClass(o)) : (i.removeClass(b.ELEM_FULL), e.removeClass(a).addClass(t), e.attr("title", s[0]), n.removeClass(o))
                        }
                    },
                    window: {
                        className: "release",
                    ...
                    var e = M(this), l = e.data("type");
                    "function" == typeof r[l].event && r[l].event(e, l), "function" == typeof v.toolsEvent && v.toolsEvent(e, l)
                }), layui.each(v.tools, function (e, l) {
                    var i = r[l] && r[l].className || l, t = r[l].title || [""];
                    d.append('<i class="layui-icon layui-icon-' + i + '" data-type="' + l + '" title="' + t[0] + '"></i>')
                }), h[0] && h.remove(), m[0] && m.remove(), u.append(n), v.tools && u.append(d), E.wrap(p).addClass(b.ELEM_ITEM).before(u), s && o.html("<iframe></iframe>"), c = function (e) {
                    var l = e.children("iframe")[0], i = (s && l ? l.srcdoc = f.join("") : e.html(f.join("")), {
                ...
                }, "preview" === a[0] ? (o.addClass(b.ELEM_SHOW), E.before(o), c(o)) : E.addClass(b.ELEM_SHOW).after(o), v.codeStyle = [v.style, v.codeStyle].join(""), v.previewStyle = [v.style, v.previewStyle].join(""), o.attr("style", v.previewStyle), w.on("tab(" + l + ")", function (e) {
                    var l = M(this), i = M(e.elem).closest("." + b.ELEM_PREVIEW).find("." + b.ELEM_ITEM),
                        e = i.eq(e.index);
                    i.removeClass(b.ELEM_SHOW), e.addClass(b.ELEM_SHOW), "preview" === l.attr("lay-id") && c(e)
                })), v.ln ? "ol" : "ul"), m = M("<" + h + ' class="layui-code-' + h + '">'),
                p = M('<div class="' + b.ELEM_TITLE + '">');
            E.addClass("layui-code-view layui-box"), v.skin && ("notepad" === v.skin && (v.skin = "dark"), E.addClass("layui-code-" + v.skin)), y = (y = v.encode ? _.escape(y) : y).replace(/[\r\t\n]+/g, "</li><li>"), E.html(m.html("<li>" + y + "</li>")), v.header && !E.children("." + b.ELEM_TITLE)[0] && (p.html(v.title + (v.about ? '<div class="layui-code-about">' + v.about + "</div>" : "")), E.prepend(p)), v.elem.length === e + 1 && "function" == typeof v.allDone && v.allDone(), 0 < (u = Math.floor(m.find("li").length / 100)) && m.css("margin-left", u + "px"), v.height && m.css("max-height", v.height), m.attr("style", v.codeStyle)
        })
    })
